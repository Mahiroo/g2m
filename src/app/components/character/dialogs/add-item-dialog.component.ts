...
@Component({
    ...
    styleUrls: ['./add-item-dialog.component.less']
})
export class AddItemDialogComponent implements OnInit {
     ...
     */
    constructor(private el: ElementRef, public dialogRef: MatDialogRef<AddItemDialogComponent>, private manager: ManagerService, private itemUtil: ItemUtilityService) { }
    ...
    add(): void {
        ...
        this.addedItems.push(this.itemUtil.getSavedItem(registItem));
        this.messages.push(`[ ${registItem.displayName} ]を装備アイテムに追加しました。`);
